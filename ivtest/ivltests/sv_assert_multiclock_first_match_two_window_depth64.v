module sv_assert_multiclock_first_match_two_window_depth64;
 bit c1=0,c2=0,a=1,b=0,c=0; int passes=0,fails=0,last=-1;
 always #1 c1=~c1;
 sp: assert property(@(posedge c1)
       first_match(a##[1:31]b##[1:32]c)|->@(posedge c2)1)
