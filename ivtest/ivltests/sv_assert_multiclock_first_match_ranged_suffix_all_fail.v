module sv_assert_multiclock_first_match_ranged_suffix_all_fail;
 bit c1=0,c2=0,a=0,b=1,x=0,good=0;int pp=0,pf=0,pt=-1,ip=0,ifail=0,it=-1;
 ...
 initial begin #9 a=1;#2 a=0;$assertoff(0,ps);$assertoff(0,is);#38 x=1;#22 x=0;#29;
   if(pp||pf!=1||pt!=75||ip||ifail!=1||it!=55)$fatal(1,"pp%0d pf%0d pt%0d ip%0d if%0d it%0d",pp,pf,pt,ip,ifail,it);
