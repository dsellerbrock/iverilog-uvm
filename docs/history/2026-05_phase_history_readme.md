...
> DV bring-up notes, and the feature/test tables of that period.
>
> It is **not** kept up to date. For current status see the top-level
> [README](../../README.md), the
> [IEEE 1800-2017 clause matrix](../conformance/matrices/ieee1800_2017_clause_matrix.md),
> and [CURRENT_WORK](../conformance/CURRENT_WORK.md). Later work is organized
> by milestones (M0–M14) rather than phases; the
> [milestone truth audit](../conformance/milestone_truth_audit_2026-07-16.md)
> is the bridge between the two eras.
