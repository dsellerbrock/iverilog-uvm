...
still fails; explicit `triggered()` calls and multi-object class-event lists
remain separate debt. Full clause 15 and application DV are not qualified.
