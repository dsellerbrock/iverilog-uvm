...
- **Boundary:** Five fixed class-property slice-to-queue assignments, virtual-interface array marshalling, and strict mixed drivers remain separate OTP blockers.
