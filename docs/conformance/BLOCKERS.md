...
- **State:** FOCUSED_TESTED on source/test commit `284a4c65d`, based on the clean pinned Earlgrey-PROD-M6 `adc_ctrl_sim` release target. Publication, exact-head CI, and merge remain pending.
