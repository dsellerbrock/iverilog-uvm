...
- **Scope:** The selected implementation may change only `vvp/vvp_z3.cc` and dedicated paired 2017/2023 constraint tests/manifests. The coordinator owns private build, broad gates, pinned CSRNG/OTP replays using named disposable overlays, evidence, review, and PR. Installed tools and pinned source checkouts stay unchanged while Caliptra VVP runs.
