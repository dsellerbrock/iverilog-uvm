...
- **Evidence:** The [focused record](session_logs/2026-09-23_caliptra_long_sequence_register_focus.json) links executable 999/1000/1001-step 2017/2023 tests and local gates. The clean pinned PM file lost both duplicate-name errors but still reported 16 separate late-default-clock errors on the original `origin/main`-based branch. PR334 is now integrated locally, with the combined pinned PM recheck pending. Full Caliptra DV and formal proof remain open.
