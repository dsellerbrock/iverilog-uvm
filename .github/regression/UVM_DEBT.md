...
Commits since full UVM: 4 (M4C-9 MEDIUM, M4C-6 LOW, M4C-9b LOW, M11-7 MEDIUM)
Highest risk change since last full run: MEDIUM — M11-7 chained covergroup sample dispatch (coverage 9/9 + smoke 14/14 + full ivtest green)
