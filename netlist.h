...
class NetObj  : public NetPins, public Attrib {
	...
	// lex_strings string, for example.
      ...
      virtual void show_type(std::ostream&fd) const override;
...
class NetAbs  : public NetNode {
    ...
    public:
      ...
      virtual void functor_node(Design*des, functor_t*fun) override;
...
class NetCompare  : public NetNode {
    ...
    public:
      ...
      virtual void functor_node(Design*, functor_t*) override;
      virtual void dump_node(std::ostream&, unsigned ind) const override;
      virtual bool emit_node(struct target_t*) const override;
...
class NetConcat  : public NetNode {
	...
	// ignored.
      ...
      void dump_node(std::ostream&, unsigned ind) const override;
      bool emit_node(struct target_t*) const override;
      void functor_node(Design*des, functor_t*fun) override;
...
class NetEConst  : public NetExpr {
    ...
    public:
      ...
      virtual NetEConst* dup_expr() const override;
      virtual NetNet*synthesize(Design*, NetScope*scope, NetExpr*) override;
      virtual NexusSet* nex_input(bool rem_out = true, bool always_sens = false,
                                  bool nested_func = false) const override;
...
class NetEConstEnum  : public NetEConst {
    ...
    public:
      ...
      virtual NetEConstEnum* dup_expr() const override;
...
class NetEConstParam  : public NetEConst {
    ...
    public:
      ...
      virtual NetEConstParam* dup_expr() const override;
...
class NetECReal  : public NetExpr {
	...
	// The type of this expression is ET_REAL
      ...
      virtual NetECReal* dup_expr() const override;
      virtual NetNet*synthesize(Design*, NetScope*scope, NetExpr*) override;
      virtual NexusSet* nex_input(bool rem_out = true, bool always_sens = false,
                                  bool nested_func = false) const override;
...
class NetECRealParam  : public NetECReal {
    ...
    public:
      ...
      virtual NetECRealParam* dup_expr() const override;
...
class NetPartSelect  : public NetNode {
	...
	/* Is the select signal signed? */
      ...
      virtual void dump_node(std::ostream&, unsigned ind) const override;
      bool emit_node(struct target_t*tgt) const override;
      virtual void functor_node(Design*des, functor_t*fun) override;
...
class NetAssignBase : public NetProc {
    ...
    public:
      ...
      virtual ~NetAssignBase() override =0;
...
class NetCase  : public NetProc {
    ...
    public:
      ...
      virtual NexusSet* nex_input(bool rem_out = true, bool always_sens = false,
                                  bool nested_func = false) const override;
      virtual void nex_output(NexusSet&out) override;
...
class NetEvWait  : public NetProc {
	...
	// process. This method checks.
      virtual bool is_asynchronous() override;

	// It is possible that this is the root of a synchronous
	// process? This method checks.
      virtual bool is_synchronous() override;
...
class NetELast : public NetExpr {
    ...
    public:
      ...
      virtual void expr_scan(struct expr_scan_t*) const override;
      virtual NetELast*dup_expr() const override;
      virtual NexusSet* nex_input(bool rem_out = true, bool always_sens = false,
                                  bool nested_func = false) const override;
