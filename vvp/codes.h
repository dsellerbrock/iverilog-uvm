...
extern bool of_AA_SET_DEFAULT_OBJ(vthread_t thr, vvp_code_t code);
extern bool of_AA_SET_DEFAULT_R(vthread_t thr, vvp_code_t code);
extern bool of_AA_SET_DEFAULT_STR(vthread_t thr, vvp_code_t code);
extern bool of_AA_SET_DEFAULT_V(vthread_t thr, vvp_code_t code);
...
extern bool of_COPYOUT_CONTEXT(vthread_t thr, vvp_code_t code);
extern bool of_COPYOUT_ENTER(vthread_t thr, vvp_code_t code);
extern bool of_COPYOUT_LEAVE(vthread_t thr, vvp_code_t code);
...
extern bool of_COMB_BEGIN(vthread_t thr, vvp_code_t code);
extern bool of_COMB_END(vthread_t thr, vvp_code_t code);
extern bool of_COMB_REGISTER(vthread_t thr, vvp_code_t code);
...
extern bool of_REP_STR_S(vthread_t thr, vvp_code_t code);
extern bool of_REP_STR_U(vthread_t thr, vvp_code_t code);
...
extern bool of_CONTAINER_LAYOUT_Q(vthread_t thr, vvp_code_t code);
...
extern bool of_FLOW_PENDING_BREAK(vthread_t thr, vvp_code_t code);
extern bool of_FLOW_PENDING_CONTINUE(vthread_t thr, vvp_code_t code);
extern bool of_JMP_FLOWBRK(vthread_t thr, vvp_code_t code);
extern bool of_JMP_FLOWCONT(vthread_t thr, vvp_code_t code);
extern bool of_DISABLE_FORK(vthread_t thr, vvp_code_t code);
extern bool of_DIM_PUSH(vthread_t thr, vvp_code_t code);
extern bool of_SLICE_PUSH(vthread_t thr, vvp_code_t code);
...
extern bool of_FILL_DAR_OBJ_OBJ(vthread_t thr, vvp_code_t code);
extern bool of_FILL_DAR_OBJ_REAL(vthread_t thr, vvp_code_t code);
extern bool of_FILL_DAR_OBJ_STR(vthread_t thr, vvp_code_t code);
extern bool of_FILL_DAR_OBJ_VEC4(vthread_t thr, vvp_code_t code);
...
extern bool of_FORCE_LINK_A(vthread_t thr, vvp_code_t code);
extern bool of_FORCE_LINK_OFF(vthread_t thr, vvp_code_t code);
extern bool of_FORCE_VEC4(vthread_t thr, vvp_code_t code);
extern bool of_FORCE_VEC4_A(vthread_t thr, vvp_code_t code);
...
extern bool of_LOAD_ARR_DAR_SLICE(vthread_t thr, vvp_code_t code);
...
extern bool of_QUEUE_TRIM_O(vthread_t thr, vvp_code_t code);
...
extern bool of_QSORT_O(vthread_t thr, vvp_code_t code);
extern bool of_QSORT_R(vthread_t thr, vvp_code_t code);
extern bool of_QSORT_R_O(vthread_t thr, vvp_code_t code);
extern bool of_QUNIQUE(vthread_t thr, vvp_code_t code);
extern bool of_QUNIQUE_O(vthread_t thr, vvp_code_t code);
...
extern bool of_RAND_MODE_GET_A_OBJ(vthread_t thr, vvp_code_t code);
extern bool of_RAND_MODE_GET_A_STR(vthread_t thr, vvp_code_t code);
extern bool of_RAND_MODE_GET_A_V(vthread_t thr, vvp_code_t code);
extern bool of_RAND_MODE_P(vthread_t thr, vvp_code_t code);
extern bool of_RAND_MODE_P_A_OBJ(vthread_t thr, vvp_code_t code);
extern bool of_RAND_MODE_P_A_STR(vthread_t thr, vvp_code_t code);
...
extern bool of_RANDOMIZE_WITH_OBJECTS(vthread_t thr, vvp_code_t code);
extern bool of_PROP_OBJ(vthread_t thr, vvp_code_t code);
extern bool of_PROP_ARR_DAR(vthread_t thr, vvp_code_t code);
extern bool of_PROP_INDEX_CHECK(vthread_t thr, vvp_code_t code);
...
extern bool of_PUTC_RET_VEC4(vthread_t thr, vvp_code_t code);
extern bool of_PUTC_STR_VEC4(vthread_t thr, vvp_code_t code);
extern bool of_PUTC_STRA_VEC4(vthread_t thr, vvp_code_t code);
...
extern bool of_REF_CAPTURE(vthread_t thr, vvp_code_t code);
extern bool of_REF_CAPTURE_AA_OBJ(vthread_t thr, vvp_code_t code);
extern bool of_REF_CAPTURE_AA_O_OBJ(vthread_t thr, vvp_code_t code);
extern bool of_REF_CAPTURE_AA_O_STR(vthread_t thr, vvp_code_t code);
extern bool of_REF_CAPTURE_AA_O_V(vthread_t thr, vvp_code_t code);
extern bool of_REF_CAPTURE_AA_STR(vthread_t thr, vvp_code_t code);
extern bool of_REF_CAPTURE_AA_V(vthread_t thr, vvp_code_t code);
extern bool of_REF_CAPTURE_EL(vthread_t thr, vvp_code_t code);
extern bool of_REF_CAPTURE_EL_O(vthread_t thr, vvp_code_t code);
extern bool of_REF_CAPTURE_PR(vthread_t thr, vvp_code_t code);
extern bool of_REF_CAPTURE_PR_I(vthread_t thr, vvp_code_t code);
extern bool of_REF_CAPTURE_W(vthread_t thr, vvp_code_t code);
extern bool of_REF_PART(vthread_t thr, vvp_code_t code);
extern bool of_REF_STORE_MBX(vthread_t thr, vvp_code_t code);
extern bool of_RELEASE_REG(vthread_t thr, vvp_code_t code);
extern bool of_RELEASE_REG_A(vthread_t thr, vvp_code_t code);
...
extern bool of_QREVERSE_O(vthread_t thr, vvp_code_t code);
extern bool of_QRSORT_KEYS(vthread_t thr, vvp_code_t code);
extern bool of_QRSORT_KEYS_O(vthread_t thr, vvp_code_t code);
extern bool of_QSHUFFLE(vthread_t thr, vvp_code_t code);
extern bool of_QSHUFFLE_O(vthread_t thr, vvp_code_t code);
extern bool of_QSORT_KEYS(vthread_t thr, vvp_code_t code);
extern bool of_QSORT_KEYS_O(vthread_t thr, vvp_code_t code);
extern bool of_QSLICE(vthread_t thr, vvp_code_t code);
extern bool of_QSLICE_LEFT(vthread_t thr, vvp_code_t code);
...
extern bool of_QUNIQUE_KEYS_O(vthread_t thr, vvp_code_t code);
...
extern bool of_RET_VEC4_VALUE(vthread_t thr, vvp_code_t code);
...
extern bool of_SET_DAR_OBJ_VEC4_OFF(vthread_t thr, vvp_code_t code);
...
extern bool of_ASSIGN_PROP_V_BITSUX(vthread_t thr, vvp_code_t code);
extern bool of_ASSIGN_PROP_V_BITSX(vthread_t thr, vvp_code_t code);
...
extern bool of_STATIC_CALL_LEAVE(vthread_t thr, vvp_code_t code);
extern bool of_STATIC_SAVE_VEC4(vthread_t thr, vvp_code_t code);
extern bool of_STATIC_SAVE_REAL(vthread_t thr, vvp_code_t code);
extern bool of_STATIC_SAVE_STR(vthread_t thr, vvp_code_t code);
extern bool of_STATIC_SAVE_OBJ(vthread_t thr, vvp_code_t code);
...
extern bool of_STREAM_FLATTEN_OBJ_WITH(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_FLATTEN_VEC_WITH(vthread_t thr, vvp_code_t code);
...
extern bool of_STREAM_RANGE_MARK(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_SPLIT_REM(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_TAKE_LEFT(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_TAKE_LEFT_WITH(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_TAKE_LEFT_REM(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_STORE_FIXED_INDEX(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_STORE_FIXED_RANGE(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_STORE_FIXED_UP(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_STORE_FIXED_DOWN(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_STORE_PROP_FIXED_INDEX(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_STORE_PROP_FIXED_RANGE(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_STORE_PROP_FIXED_UP(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_STORE_PROP_FIXED_DOWN(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_TO_DAR(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_TO_DAR_WITH(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_TO_QUEUE(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_TO_QUEUE_WITH(vthread_t thr, vvp_code_t code);
...
extern bool of_SWAP_OBJ(vthread_t thr, vvp_code_t code);
...
extern bool of_WAIT_VIF_POSEDGE_I(vthread_t thr, vvp_code_t code);
extern bool of_WAIT_VIF_NEGEDGE(vthread_t thr, vvp_code_t code);
extern bool of_WAIT_VIF_NEGEDGE_I(vthread_t thr, vvp_code_t code);
