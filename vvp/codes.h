...
extern bool of_EVENT_OBJ(vthread_t thr, vvp_code_t code);
...
extern bool of_FORK_VIF(vthread_t thr, vvp_code_t code);
...
extern bool of_LOAD_DAR_OBJ_OBJ(vthread_t thr, vvp_code_t code);
extern bool of_LOAD_DAR_OBJ_VEC4(vthread_t thr, vvp_code_t code);
extern bool of_LOAD_DAR_OBJ_STR(vthread_t thr, vvp_code_t code);
...
extern bool of_STORE_PROP_V_I_BITS(vthread_t thr, vvp_code_t code);
...
extern bool of_STREAM_OBJ(vthread_t thr, vvp_code_t code);
extern bool of_STREAM_VEC4(vthread_t thr, vvp_code_t code);
