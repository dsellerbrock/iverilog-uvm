...
%token K_CLASS K_CLASS_STRUCT K_CLASS_UNION K_CLASS_UNION_TAGGED K_IMPLEMENTS K_STATIC_PROP K_CONSTRAINT_DEF K_CONSTRAINT_CALL K_CONSTRAINT_DEP K_COVGRP_BIN K_COVGRP_DYN_BIN K_COVGRP_DYN_TRANS K_COVGRP_CROSS K_COVGRP_CROSS_TERM K_COVGRP_CROSS_BIN K_COVGRP_ITEM K_COVGRP_OPTIONS K_COVGRP_TYPE_WEIGHT K_COVGRP_ITEM_TYPE_WEIGHT K_COVGRP_ITEM_OPTIONS K_COVGRP_PARENT K_COVGRP_SRC K_MODPORT
...
class_property
  ...
  | K_IMPLEMENTS T_STRING
      { compile_class_interface($2); }
  | K_STATIC_PROP T_NUMBER T_SYMBOL
      { compile_class_static_property($2, $3); }
  | K_CONSTRAINT_DEF T_STRING T_STRING
      { compile_class_constraint($2, $3); }
  | K_CONSTRAINT_DEP T_NUMBER T_NUMBER T_NUMBER
	{ compile_class_constraint_dep($2, $3, $4); }
  | K_CONSTRAINT_CALL T_NUMBER T_STRING T_STRING T_NUMBER T_NUMBER
      { compile_class_constraint_call($2, $3, $4, $5, $6); }
  ...
  | K_COVGRP_DYN_BIN T_NUMBER T_NUMBER T_NUMBER T_NUMBER T_NUMBER T_STRING T_STRING T_STRING T_STRING covgrp_guard_opt
      { compile_class_covgrp_dyn_bin($2, $3, $4, $5, $6, $7, $8, $9,
				     $11, $10); }
  | K_COVGRP_DYN_TRANS T_NUMBER T_NUMBER T_NUMBER T_NUMBER T_NUMBER T_STRING T_STRING T_STRING T_STRING T_NUMBER T_NUMBER T_NUMBER T_NUMBER T_NUMBER T_NUMBER
      { compile_class_covgrp_dyn_bin($2, $3, $4, $5, $6, $7, $8, $9,
				     $11, $10, $12, $13, $14, $15, $16); }
  | K_COVGRP_CROSS T_NUMBER T_NUMBER T_NUMBER T_NUMBER
      { compile_class_covgrp_cross($2, $3, $4, $5); }
  | K_COVGRP_CROSS_TERM T_NUMBER T_NUMBER T_NUMBER T_NUMBER T_NUMBER T_NUMBER
      { compile_class_covgrp_cross_term($2, $3, $4, $5, $6, $7); }
  | K_COVGRP_CROSS_BIN T_NUMBER T_NUMBER T_NUMBER T_STRING T_STRING
      { compile_class_covgrp_cross_bin($2, $3, $4, $5, $6); }
  ...
  | K_COVGRP_OPTIONS T_NUMBER T_NUMBER T_NUMBER T_NUMBER T_NUMBER
      { compile_class_covgrp_options($2, $3, $4, $5, $6); }
  | K_COVGRP_TYPE_WEIGHT T_NUMBER
      { compile_class_covgrp_type_weight($2); }
  | K_COVGRP_ITEM_TYPE_WEIGHT T_NUMBER T_NUMBER
      { compile_class_covgrp_item_type_weight($2, $3); }
  | K_COVGRP_ITEM_OPTIONS T_NUMBER T_NUMBER T_NUMBER
      { compile_class_covgrp_item_options($2, $3, $4); }
