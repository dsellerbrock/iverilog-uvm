...
%token K_CLASS K_CLASS_STRUCT K_CLASS_UNION K_CLASS_UNION_TAGGED K_IMPLEMENTS K_STATIC_PROP K_CONSTRAINT_DEF K_CONSTRAINT_CALL K_CONSTRAINT_DEP K_COVGRP_BIN K_COVGRP_DYN_BIN K_COVGRP_CROSS K_COVGRP_CROSS_TERM K_COVGRP_CROSS_BIN K_COVGRP_ITEM K_COVGRP_OPTIONS K_COVGRP_TYPE_WEIGHT K_COVGRP_ITEM_TYPE_WEIGHT K_COVGRP_ITEM_OPTIONS K_COVGRP_PARENT K_COVGRP_SRC K_MODPORT
