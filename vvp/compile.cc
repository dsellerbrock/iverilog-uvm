...
static const struct opcode_table_s opcode_table[] = {
      ...
      { "%da/and",  of_DA_AND,  1,{OA_FUNC_PTR, OA_NONE,     OA_NONE} },
      { "%da/max",  of_DA_MAX,  1,{OA_FUNC_PTR, OA_NONE,     OA_NONE} },
      { "%da/min",  of_DA_MIN,  1,{OA_FUNC_PTR, OA_NONE,     OA_NONE} },
      { "%da/or",   of_DA_OR,   1,{OA_FUNC_PTR, OA_NONE,     OA_NONE} },
      { "%da/prod", of_DA_PROD, 1,{OA_FUNC_PTR, OA_NONE,     OA_NONE} },
      { "%da/sum",  of_DA_SUM,  1,{OA_FUNC_PTR, OA_NONE,     OA_NONE} },
      { "%da/xor",  of_DA_XOR,  1,{OA_FUNC_PTR, OA_NONE,     OA_NONE} },
