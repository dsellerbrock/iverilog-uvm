...
static const struct opcode_table_s opcode_table[] = {
      { "%aa/clear", of_AA_CLEAR, 0, {OA_NONE,     OA_NONE,     OA_NONE} },
      ...
      { "%aa/load/sig/str/str", of_AA_LOAD_SIG_STR_STR, 1, {OA_FUNC_PTR, OA_NONE, OA_NONE} },
      { "%aa/load/sig/v/obj", of_AA_LOAD_SIG_V_OBJ, 2, {OA_FUNC_PTR, OA_BIT1, OA_NONE} },
      { "%aa/load/sig/v/str", of_AA_LOAD_SIG_V_STR, 1, {OA_FUNC_PTR, OA_NONE, OA_NONE} },
      ...
      { "%event/obj",of_EVENT_OBJ,1, {OA_FUNC_PTR, OA_NONE, OA_NONE} },
      { "%event/triggered", of_EVENT_TRIGGERED, 1, {OA_FUNC_PTR, OA_NONE, OA_NONE} },
      ...
      { "%fork/vif",of_FORK_VIF,2, {OA_CODE_PTR2,OA_VPI_PTR,  OA_NONE} },
      ...
      { "%load/dar/obj/obj",of_LOAD_DAR_OBJ_OBJ,0,{OA_NONE,OA_NONE,OA_NONE} },
      { "%load/dar/obj/str",of_LOAD_DAR_OBJ_STR,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      ...
      { "%qand",         of_QAND,         1,{OA_FUNC_PTR,OA_NONE,OA_NONE} },
      ...
      { "%qprod",         of_QPROD,          1,{OA_FUNC_PTR,OA_NONE,OA_NONE} },
      { "%qpush_back/v",  of_QPUSH_BACK_V,   3,{OA_FUNC_PTR,OA_BIT1,OA_BIT2} },
      { "%qpush_front/v", of_QPUSH_FRONT_V,  3,{OA_FUNC_PTR,OA_BIT1,OA_BIT2} },
      ...
      { "%qslice",          of_QSLICE,           1,{OA_FUNC_PTR,OA_NONE,OA_NONE} },
      ...
      { "%qsum",       of_QSUM,    1,{OA_FUNC_PTR,OA_NONE,OA_NONE} },
      ...
      { "%store/prop/v/i/bits",of_STORE_PROP_V_I_BITS,3,{OA_NUMBER,OA_BIT1,OA_BIT2} },
      ...
      { "%stream/obj",  of_STREAM_OBJ,  2, {OA_BIT1, OA_BIT2, OA_NONE} },
      { "%stream/vec4", of_STREAM_VEC4, 2, {OA_BIT1, OA_BIT2, OA_NONE} },
      ...
      { "%uarray_reverse",  of_UARRAY_REVERSE, 1,{OA_ARR_PTR, OA_NONE,OA_NONE} },
      { "%uarray_rsort",    of_UARRAY_RSORT,   1,{OA_ARR_PTR, OA_NONE,OA_NONE} },
      { "%uarray_shuffle",  of_UARRAY_SHUFFLE, 1,{OA_ARR_PTR, OA_NONE,OA_NONE} },
      { "%uarray_sort",     of_UARRAY_SORT,    1,{OA_ARR_PTR, OA_NONE,OA_NONE} },
      ...
      { "%wait/obj",of_WAIT_OBJ, 0,  {OA_NONE,     OA_NONE,     OA_NONE} },
