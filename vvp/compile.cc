...
static const struct opcode_table_s opcode_table[] = {
      ...
      { "%aa/first/sig/sv", of_AA_FIRST_SIG_SV, 2, {OA_FUNC_PTR, OA_FUNC_PTR2, OA_NONE} },
      ...
      { "%aa/first/sv", of_AA_FIRST_SV, 2, {OA_FUNC_PTR, OA_BIT1, OA_NONE} },
      ...
      { "%aa/last/sig/sv", of_AA_LAST_SIG_SV, 2, {OA_FUNC_PTR, OA_FUNC_PTR2, OA_NONE} },
      ...
      { "%aa/last/sv", of_AA_LAST_SV, 2, {OA_FUNC_PTR, OA_BIT1, OA_NONE} },
      ...
      { "%aa/loadlv/o/q/obj", of_AA_LOADLV_O_Q_OBJ, 1, {OA_STRING, OA_NONE, OA_NONE} },
      { "%aa/loadlv/o/q/str", of_AA_LOADLV_O_Q_STR, 1, {OA_STRING, OA_NONE, OA_NONE} },
      { "%aa/loadlv/o/q/v",   of_AA_LOADLV_O_Q_V,   1, {OA_STRING, OA_NONE, OA_NONE} },
      { "%aa/loadlv/sig/obj/obj", of_AA_LOADLV_SIG_OBJ_OBJ, 1, {OA_FUNC_PTR, OA_NONE, OA_NONE} },
      { "%aa/loadlv/sig/obj/str", of_AA_LOADLV_SIG_OBJ_STR, 1, {OA_FUNC_PTR, OA_NONE, OA_NONE} },
      { "%aa/loadlv/sig/obj/v", of_AA_LOADLV_SIG_OBJ_V, 1, {OA_FUNC_PTR, OA_NONE, OA_NONE} },
      { "%aa/new/default/obj", of_AA_NEW_DEFAULT_OBJ, 0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%aa/new/default/r", of_AA_NEW_DEFAULT_R, 0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%aa/new/default/str", of_AA_NEW_DEFAULT_STR, 0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%aa/new/default/v", of_AA_NEW_DEFAULT_V, 1, {OA_BIT1, OA_NONE, OA_NONE} },
      ...
      { "%aa/next/sig/sv", of_AA_NEXT_SIG_SV, 2, {OA_FUNC_PTR, OA_FUNC_PTR2, OA_NONE} },
      ...
      { "%aa/next/sv", of_AA_NEXT_SV, 2, {OA_FUNC_PTR, OA_BIT1, OA_NONE} },
      ...
      { "%aa/prev/sig/sv", of_AA_PREV_SIG_SV, 2, {OA_FUNC_PTR, OA_FUNC_PTR2, OA_NONE} },
      ...
      { "%aa/prev/sv", of_AA_PREV_SV, 2, {OA_FUNC_PTR, OA_BIT1, OA_NONE} },
      { "%aa/prev/v", of_AA_PREV_V, 2, {OA_FUNC_PTR, OA_BIT1, OA_NONE} },
      { "%aa/set/default/obj", of_AA_SET_DEFAULT_OBJ, 0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%aa/set/default/r", of_AA_SET_DEFAULT_R, 0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%aa/set/default/str", of_AA_SET_DEFAULT_STR, 0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%aa/set/default/v", of_AA_SET_DEFAULT_V, 1, {OA_BIT1, OA_NONE, OA_NONE} },
      ...
      { "%aa/viv/o/obj", of_AA_VIV_O_OBJ, 1, {OA_NUMBER,   OA_NONE,     OA_NONE} },
      { "%aa/viv/o/str", of_AA_VIV_O_STR, 1, {OA_NUMBER,   OA_NONE,     OA_NONE} },
      { "%aa/viv/o/v",   of_AA_VIV_O_V,   1, {OA_NUMBER,   OA_NONE,     OA_NONE} },
      { "%aa/viv/sig/obj", of_AA_VIV_SIG_OBJ, 2, {OA_FUNC_PTR, OA_BIT1, OA_NONE} },
      { "%aa/viv/sig/str", of_AA_VIV_SIG_STR, 2, {OA_FUNC_PTR, OA_BIT1, OA_NONE} },
      { "%aa/viv/sig/v", of_AA_VIV_SIG_V, 2, {OA_FUNC_PTR, OA_BIT1,     OA_NONE} },
	...
	{OA_CONTAINER_DATA_STRING, OA_CONTAINER_DATA_MAX,
	 OA_CONTAINER_DATA_PROTO} },
      ...
      { "%append/qobj/r",   of_APPEND_QOBJ_R,   2, {OA_FUNC_PTR, OA_BIT1, OA_NONE} },
      { "%append/qobj/str", of_APPEND_QOBJ_STR, 2, {OA_FUNC_PTR, OA_BIT1, OA_NONE} },
      { "%append/qobj/v",   of_APPEND_QOBJ_V,   3, {OA_FUNC_PTR, OA_BIT1, OA_BIT2} },
      ...
      { "%assign/prop/v/bits", of_ASSIGN_PROP_V_BITS, 3,
	{OA_NUMBER, OA_BIT1, OA_BIT2} },
      { "%assign/prop/v/bits/ux", of_ASSIGN_PROP_V_BITSUX, 3,
	{OA_NUMBER, OA_BIT1, OA_BIT2} },
      { "%assign/prop/v/bits/x", of_ASSIGN_PROP_V_BITSX, 3,
	{OA_NUMBER, OA_BIT1, OA_BIT2} },
      ...
      { "%box/real", of_BOX_REAL,0,  {OA_NONE,  OA_NONE,     OA_NONE} },
      { "%box/str",  of_BOX_STR, 0,  {OA_NONE,  OA_NONE,     OA_NONE} },
      ...
      { "%comb/begin",    of_COMB_BEGIN,    0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%comb/end",      of_COMB_END,      0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%comb/register", of_COMB_REGISTER, 0, {OA_NONE, OA_NONE, OA_NONE} },
	...
	{OA_CONTAINER_DATA_STRING,OA_CONTAINER_DATA_MAX,OA_NONE} },
      { "%copyout/context",of_COPYOUT_CONTEXT,1,{OA_BIT1,OA_NONE,OA_NONE} },
      { "%copyout/enter",of_COPYOUT_ENTER,1,{OA_VPI_PTR,OA_NONE,OA_NONE} },
      { "%copyout/leave",of_COPYOUT_LEAVE,0,{OA_NONE,OA_NONE,OA_NONE} },
      ...
      { "%defer/enqueue",of_DEFER_ENQUEUE,2,{OA_CODE_PTR2,OA_VPI_PTR,OA_NONE} },
      { "%defer/final",of_DEFER_FINAL,2,{OA_CODE_PTR2,OA_VPI_PTR,OA_NONE} },
      { "%defer/final/key",of_DEFER_FINAL_KEY,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%defer/final/taskkey",of_DEFER_FINAL_TASK_KEY,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      ...
      { "%dpi/call/task/ack",of_DPI_CALL_TASK_ACK,2,{OA_STRING,OA_BIT1,OA_NONE} },
      ...
      { "%dup/obj/ref", of_DUP_OBJ_REF, 0, {OA_NONE, OA_NONE, OA_NONE} },
      ...
      { "%fill/dar/obj/obj", of_FILL_DAR_OBJ_OBJ, 0,{OA_NONE,OA_NONE,OA_NONE} },
      { "%fill/dar/obj/real",of_FILL_DAR_OBJ_REAL,0,{OA_NONE,OA_NONE,OA_NONE} },
      { "%fill/dar/obj/str", of_FILL_DAR_OBJ_STR, 0,{OA_NONE,OA_NONE,OA_NONE} },
      { "%fill/dar/obj/vec4",of_FILL_DAR_OBJ_VEC4,0,{OA_NONE,OA_NONE,OA_NONE} },
      ...
      { "%force/vec4/a",  of_FORCE_VEC4_A,  2,{OA_ARR_PTR, OA_BIT1,       OA_NONE} },
      ...
      { "%hist/on", of_HIST_ON, 1, {OA_FUNC_PTR, OA_NONE,    OA_NONE} },
      ...
      { "%load/arr/dar/slice",of_LOAD_ARR_DAR_SLICE,3,{OA_ARR_PTR,OA_BIT1,OA_BIT2} },
      ...
      { "%load/preponed", of_LOAD_PREPONED, 1,{OA_FUNC_PTR,OA_NONE, OA_NONE} },
      { "%load/preponed/av", of_LOAD_PREPONED_AV, 2,{OA_ARR_PTR, OA_BIT1, OA_NONE} },
      { "%load/preponed/real", of_LOAD_PREPONED_REAL, 1,{OA_FUNC_PTR,OA_NONE, OA_NONE} },
      ...
      { "%process/resume",of_PROCESS_RESUME,0,{OA_NONE, OA_NONE, OA_NONE} },
      ...
      { "%prop/r/i",of_PROP_R_I,2,  {OA_NUMBER,   OA_BIT1,     OA_NONE} },
      { "%prop/str",of_PROP_STR,1,  {OA_NUMBER,   OA_NONE,     OA_NONE} },
      { "%prop/str/i",of_PROP_STR_I,2,{OA_NUMBER, OA_BIT1,     OA_NONE} },
      ...
      { "%qinsert/o/real/max",of_QINSERT_O_REAL,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%qinsert/o/str", of_QINSERT_O_STR, 0,{OA_NONE, OA_NONE, OA_NONE} },
      { "%qinsert/o/str/max",of_QINSERT_O_STR,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%qinsert/o/v",   of_QINSERT_O_V,   1,{OA_BIT1, OA_NONE, OA_NONE} },
      { "%qinsert/o/v/max",of_QINSERT_O_V,  2,{OA_NUMBER,OA_BIT1,OA_NONE} },
	...
	{ "%qunique/o",  of_QUNIQUE_O,1,{OA_BIT1,OA_NONE,OA_NONE} },
      ...
      { "%rand_mode/get/a/obj",of_RAND_MODE_GET_A_OBJ,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%rand_mode/get/a/str",of_RAND_MODE_GET_A_STR,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%rand_mode/get/a/v",of_RAND_MODE_GET_A_V,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%rand_mode/get/i",of_RAND_MODE_GET_I, 3,{OA_NUMBER, OA_BIT1,OA_BIT2} },
      { "%rand_mode/get/last",of_RAND_MODE_GET_LAST,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%rand_mode/p",    of_RAND_MODE_P,     1,{OA_NUMBER, OA_NONE,OA_NONE} },
      { "%rand_mode/p/a/obj",of_RAND_MODE_P_A_OBJ,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%rand_mode/p/a/str",of_RAND_MODE_P_A_STR,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      ...
      { "%ref/bind/el",of_REF_BIND_EL,2,{OA_FUNC_PTR,OA_FUNC_PTR2,OA_NONE} },
      ...
      { "%rep/str/s", of_REP_STR_S,   1,{OA_NUMBER,  OA_NONE,OA_NONE} },
      { "%rep/str/u", of_REP_STR_U,   1,{OA_NUMBER,  OA_NONE,OA_NONE} },
      ...
      { "%ret/vec4/v",of_RET_VEC4_VALUE,2,{OA_NUMBER, OA_BIT1} },
      ...
      /* Semaphore opcodes (alphabetical within %sem/) */
      ...
      { "%set/dar/obj/vec4/off",of_SET_DAR_OBJ_VEC4_OFF,3,{OA_BIT1,OA_BIT2,OA_NUMBER} },
      { "%set_randstate", of_SET_RANDSTATE, 0,{OA_NONE, OA_NONE, OA_NONE} },
      { "%setbits/vec4",  of_SETBITS_VEC4,  2, {OA_BIT1, OA_BIT2, OA_NONE} },
      { "%setbits/vec4/x",of_SETBITS_VEC4_X,2, {OA_BIT1, OA_BIT2, OA_NONE} },
      ...
      { "%slice/push",of_SLICE_PUSH,2,{OA_BIT1,OA_BIT2,OA_NONE} },
      { "%split/vec4",    of_SPLIT_VEC4,    1,{OA_NUMBER,   OA_NONE, OA_NONE} },
      { "%srandom",  of_SRANDOM,  0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%static/call/arg",  of_STATIC_CALL_ARG,  2,{OA_VPI_PTR,OA_BIT1,OA_NONE} },
      { "%static/call/enter",of_STATIC_CALL_ENTER,1,{OA_VPI_PTR,OA_NONE,OA_NONE} },
      { "%static/call/exec", of_STATIC_CALL_EXEC, 1,{OA_VPI_PTR,OA_NONE,OA_NONE} },
      { "%static/call/leave",of_STATIC_CALL_LEAVE,1,{OA_VPI_PTR,OA_NONE,OA_NONE} },
      { "%static/save/obj",  of_STATIC_SAVE_OBJ,  1,{OA_FUNC_PTR,OA_NONE,OA_NONE} },
      { "%static/save/real", of_STATIC_SAVE_REAL, 2,{OA_VPI_PTR,OA_FUNC_PTR2,OA_NONE} },
      ...
      { "%store/arr/dar/slice",of_STORE_ARR_DAR_SLICE,2,{OA_ARR_PTR,OA_BIT1,OA_NONE} },
      ...
      { "%store/obj/open",of_STORE_OBJ_OPEN,1,{OA_FUNC_PTR,OA_NONE,OA_NONE} },
      { "%store/obja",  of_STORE_OBJA,  2, {OA_ARR_PTR, OA_BIT1, OA_NONE} },
      { "%store/prop/arr/dar",of_STORE_PROP_ARR_DAR,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%store/prop/obj",of_STORE_PROP_OBJ,2, {OA_NUMBER,  OA_BIT1, OA_NONE} },
      { "%store/prop/r",  of_STORE_PROP_R,  1, {OA_NUMBER,  OA_NONE, OA_NONE} },
      { "%store/prop/r/i",of_STORE_PROP_R_I,2, {OA_NUMBER,  OA_BIT1, OA_NONE} },
      ...
      { "%store/qo/b/obj/max",of_STORE_QO_B_OBJ,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%store/qo/b/r",   of_STORE_QO_B_R,   0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%store/qo/b/r/max",of_STORE_QO_B_R,  1, {OA_NUMBER,OA_NONE,OA_NONE} },
      { "%store/qo/b/str", of_STORE_QO_B_STR, 0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%store/qo/b/str/max",of_STORE_QO_B_STR,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%store/qo/b/v",   of_STORE_QO_B_V,   1, {OA_BIT1, OA_NONE, OA_NONE} },
      { "%store/qo/b/v/max",of_STORE_QO_B_V,  2, {OA_NUMBER,OA_BIT1,OA_NONE} },
      { "%store/qo/f/obj", of_STORE_QO_F_OBJ, 0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%store/qo/f/obj/max",of_STORE_QO_F_OBJ,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%store/qo/f/r",   of_STORE_QO_F_R,   0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%store/qo/f/r/max",of_STORE_QO_F_R,  1, {OA_NUMBER,OA_NONE,OA_NONE} },
      { "%store/qo/f/str", of_STORE_QO_F_STR, 0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%store/qo/f/str/max",of_STORE_QO_F_STR,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%store/qo/f/v",   of_STORE_QO_F_V,   1, {OA_BIT1, OA_NONE, OA_NONE} },
      { "%store/qo/f/v/max",of_STORE_QO_F_V,  2, {OA_NUMBER,OA_BIT1,OA_NONE} },
      { "%store/qo/i/obj", of_STORE_QO_I_OBJ, 0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%store/qo/i/obj/max",of_STORE_QO_I_OBJ,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%store/qo/i/r",   of_STORE_QO_I_R,   0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%store/qo/i/r/max",of_STORE_QO_I_R,  1, {OA_NUMBER,OA_NONE,OA_NONE} },
      { "%store/qo/i/str", of_STORE_QO_I_STR, 0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%store/qo/i/str/max",of_STORE_QO_I_STR,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%store/qo/i/v",   of_STORE_QO_I_V,   1, {OA_BIT1, OA_NONE, OA_NONE} },
      { "%store/qo/i/v/max",of_STORE_QO_I_V,  2, {OA_NUMBER,OA_BIT1,OA_NONE} },
      ...
      { "%store/qslice/obj",of_STORE_QSLICE_OBJ,2,{OA_FUNC_PTR,OA_BIT1,OA_NONE} },
      { "%store/qslice/r",of_STORE_QSLICE_R,2,{OA_FUNC_PTR,OA_BIT1,OA_NONE} },
      { "%store/qslice/str",of_STORE_QSLICE_STR,2,{OA_FUNC_PTR,OA_BIT1,OA_NONE} },
      { "%store/qslice/v",of_STORE_QSLICE_V,3,{OA_FUNC_PTR,OA_BIT1,OA_BIT2} },
      ...
      { "%store/vec4/v",  of_STORE_VEC4_VALUE,2,{OA_FUNC_PTR,OA_BIT1,OA_NONE} },
      ...
      { "%test_nul/obj/prop", of_TEST_NUL_OBJ_PROP, 0,{OA_NONE, OA_NONE, OA_NONE} },
      ...
      { "%wait/obj/expr/negedge",of_WAIT_OBJ_EXPR_NEGEDGE,2,{OA_FUNC_PTR,OA_CODE_PTR2,OA_NONE} },
      { "%wait/obj/expr/posedge",of_WAIT_OBJ_EXPR_POSEDGE,2,{OA_FUNC_PTR,OA_CODE_PTR2,OA_NONE} },
      ...
      { "%wait/vif/posedge/i",of_WAIT_VIF_POSEDGE_I,2,{OA_NUMBER,OA_BIT1,OA_NONE} },
